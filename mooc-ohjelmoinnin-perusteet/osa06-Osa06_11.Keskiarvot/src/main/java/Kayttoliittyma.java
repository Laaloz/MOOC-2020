...
public class Kayttoliittyma {
    ...
    public String tulostaArvosanojenKeskiarvo() {
        return "Arvosanojen keskiarvo: " + rekisteri.arvosanojenKeskiarvo();
    }
    
    public String tulostaKoepisteidenKeskiarvo() {
        return "Koepisteiden keskiarvo: " + rekisteri.koepisteidenKeskiarvo();
    }
}
